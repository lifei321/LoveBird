...
- (void)viewDidLoad {
    ...
    [self.view addSubview:[self makeCellView:CGPointMake(SCREEN_WIDTH / 3, AutoSize6(172) +  titleLabel.bottom  + AutoSize6(37)) text:@"黄色" image:@"step_4_5" selectImage:@"step_yes_4_5" enabel:@"step_no_4_5" tag:305]];
    [self.view addSubview:[self makeCellView:CGPointMake(SCREEN_WIDTH * 2/ 3, AutoSize6(172) + titleLabel.bottom + AutoSize6(37)) text:@"褐色" image:@"step_4_6" selectImage:@"step_yes_4_6" enabel:@"step_no_4_6" tag:306]];
    [self.view addSubview:[self makeCellView:CGPointMake(0, AutoSize6(344) + titleLabel.bottom + AutoSize6(37)) text:@"绿色" image:@"step_4_7" selectImage:@"step_yes_4_7" enabel:@"step_no_4_7" tag:307]];
