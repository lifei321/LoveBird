...
- (UITableView *) tableView{
    if (_tableView == nil){
        ...
        _tableView.backgroundColor = kColoreDefaultBackgroundColor;
...
- (void)tableView:(UITableView *)tableView willDisplayCell:(UITableViewCell *)cell forRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    myCell.viedioModel = self.arrayDS[indexPath.row];
}
//cell离开tableView时调用
...
- (void)cl_tableViewCellPlayVideoWithCell:(PlayerCell *)cell{
    ...
    //销毁播放器
    [_playerView destroyPlayer];
    CLPlayerView *playerView = [[CLPlayerView alloc] initWithFrame:CGRectMake(0, 10, cell.CLwidth, cell.CLheight - 20)];
    ...
    //视频地址
    _playerView.url = [NSURL URLWithString:cell.viedioModel.video_url];
    //播放
