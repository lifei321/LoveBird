...
@interface AppLaunchAdManager ()<XHLaunchAdDelegate>



@end

@implementation AppLaunchAdManager
...
+(AppLaunchAdManager *)shareManager{
    static AppLaunchAdManager *instance = nil;
    static dispatch_once_t oneToken;
    dispatch_once(&oneToken,^{
        instance = [[AppLaunchAdManager alloc] init];
    });
    return instance;
}
- (instancetype)init
...
#pragma mark - customSkipView  自定义跳过按钮
...
-(void)example01
{
    ...
    //广告数据请求
    [AppHttpManager GET:nil parameters:nil jsonModelName:[AppLaunchAdModel class] success:^(AppBaseModel *responseObject) {
        
        //广告数据转模型
        AppLaunchAdModel *model = (AppLaunchAdModel *)responseObject;
